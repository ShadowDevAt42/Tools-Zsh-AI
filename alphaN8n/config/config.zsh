...
export APP_NAME APP_VERSION ROOT_DIR LOG_DIR CONFIG_DIR APP_DIR CACHE_DIR UTILS_DIR CORE_DIR SERVER_DIR
export LOG_FILE CACHE_FILE LOG_LEVEL MAX_LOG_SIZE MAX_LOG_FILE CACHE_EXPIRY CACHE_RESET_ON_START
